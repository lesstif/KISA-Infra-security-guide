...
![시스템 확장 저장 프로시저 확인](../../images/08_dbms/d-24-1.jpg "시스템 확장 저장 프로시저 확인")

**Step 3) 각 시스템 확장 저장 프로시저 제한 > 마우스 우클릭 > 속성**

![시스템 확장 저장 프로시저 속성 확인](../../images/08_dbms/d-24-2.jpg "시스템 확장 저장 프로시저 속성 확인")

**Step 4) 사용 권한 > public 실행 권한 제거(체크 해제)**

![public 실행 권한 제거](../../images/08_dbms/d-24-3.jpg "public 실행 권한 제거")

!!! info "시스템 확장 저장 프로시저 제한"
