...
`Oracle_HomeDirectory/admin/pfile/init.ora`에서 `OS_ROLE = FALSE` 추가 및 인스턴스 재시작
...
`Oracle_HomeDirectory/admin/pfile/init.ora`에서 `remote_os_authent = FALSE` 추가 및 인스턴스 재시작
...
`Oracle_HomeDirectory/admin/pfile/init.ora`에서 `remote_os_roles = FALSE` 추가 및 인스턴스 재시작
