...
![암호 만료 강제 적용 설정](../../images/08_dbms/d-03.jpg "암호 만료 강제 적용 설정")

**Step 3) OS 암호 정책 설정**

`[관리 도구] > [로컬 보안 정책] > [보안 설정] > [계정 정책] > [암호 정책] > 최대 암호 사용 기간 : '60일' 설정`

![최대 암호 사용 기간 설정](../../images/08_dbms/d-03.jpg "최대 암호 사용 기간 설정")
...
![사용자별 비밀번호 PROFILE 적용 여부 확인](../../images/08_dbms/d-03.jpg "사용자별 비밀번호 PROFILE 적용 여부 확인")
...
![PROFILE 설정 내용 확인](../../images/08_dbms/d-03.jpg "PROFILE 설정 내용 확인")
