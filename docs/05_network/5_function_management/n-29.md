...
!!! info "BOOTP 서비스"
    네트워크를 이용하여 사용자가 OS를 로드할 수 있게 하며, 자동으로 IP주소를 받게 하고, 부팅 파일 정보를 서버로부터 요청하여 부팅하는 데 사용하는 프로토콜
...
1.  **bootp 서비스 설정 확인**
    ...
    ```
2.  **DHCP 서버 IP주소와 서버가 연결된 스위치에 대한 인터페이스 지정 옵션 제거**
    ```bash
