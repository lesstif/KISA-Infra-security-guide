...
# ntpq -pn 예시) <IP 주소1> <IP 주소2>    3 u   67   64   12     3.11  -425167 7877.17
...
예시) *<IP 주소1>     133.243.238.244  2 u   53   64  377    5.730   +2.025   8.323 +<IP 주소2> <IP 주소3>   3 u   49   64  377    5.838  -16.050  16.484 -<IP 주소4>   <IP 주소5>     2 u    2   64  377  187.934   -8.059  81.846 (이하 생략)
...
!!! info "Redhat 계열 리눅스는 RHEL 8 버전부터 Chrony 서비스로 변경"
...
# chronyc sources 예시) ^- <IP 주소>                3   6    37     4   -135us[ +209us] +/-   56ms ^- <IP 주소>                3   6    37     5   +841us[+1184us] +/-   57ms (이하 생략)
